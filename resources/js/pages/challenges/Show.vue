...
const submitStub = ref<string | null>(null);
...
async function submitFlag(): Promise<void> {
    ...
    try {
        ...
        if (res.status === 501) {
            submitStub.value = t('challenges.show.submit.stub');
        } else if (!res.ok) {
    ...
    <PublicLayout>
        <article class="mx-auto max-w-4xl px-6 py-12">
            ...
            <header class="mt-6 flex flex-col gap-3">
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                        {{
                            t(
                                `challenges.browse.category.${challenge.category}`,
                            )
                        }}
                    </span>
                    <span
            ...
            >
                ...
                <div v-else-if="hasHints" class="mt-3 space-y-3">
                    ...
                    >
                        ...
                        <p
                            class="mt-2 text-sm whitespace-pre-line text-slate-300"
                        >
                            {{ hint }}
                        </p>
                    </details>
            ...
            >
                ...
                <template v-if="challenge.can_submit">
                    <form
                    ...
                    <p
                        v-if="submitStub"
                        class="mt-3 rounded-md border border-amber-500/40 bg-amber-500/10 p-3 text-sm text-amber-200"
                    >
                        {{ submitStub }}
                    </p>
                    <p
